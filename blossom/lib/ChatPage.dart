...
class _ChatPageState extends State<ChatPage> {
  final List<ChatMessage> _messages = <ChatMessage>[new ChatMessage(
    text: "Hi there! This is a reminder that you have an event coming up in 3 days! The event you have successfully registered for is: #I Am Remarkable workshop for YOUth. Could you please confirm that you are attending the event? (Yes/No)",
    name: "Blossom",
    type: false,
  )];
